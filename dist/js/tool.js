...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_multiselect__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_multiselect___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_multiselect__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__AdjustmentItem__ = __webpack_require__(25);
	...
	methods: {
		...
		applyAdjustment: function applyAdjustment() {
			...
			Nova.request().post('/nova-vendor/invoice-adjustment/apply', vm.invoice).then(function (response) {
				...
				_this2.$toasted.show(error.response.data, { type: 'error' });
			}).finally(function () {
				vm.loading = false;
			});
		}
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("multiselect", {
        staticClass: "mb-3",
        attrs: { options: _vm.invoices, label: "reference", "track-by": "id" },
        model: {
          value: _vm.invoice,
          callback: function($$v) {
            _vm.invoice = $$v
      ...
      _vm._v(" "),
      _c("pre", [_c("code", [_vm._v(_vm._s(_vm.invoice))])])
    ],
    1
  )
}
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "adjustment-item", class: { "is-delete": !!_vm.deleted } },
    [
      _c("p", [_vm._v("Name: " + _vm._s(_vm.item.streaming.name))]),
      _vm._v(" "),
      _c("p", [
        _vm._v("Discount: " + _vm._s(_vm.item.discount ? "yes" : "no"))
      ]),
      _vm._v(" "),
